...
pub struct SerializableRuleCore {
    ...
    pub constraints: Option<RapidMap<String, SerializableRule>>,
    /// Utility rules that can be used in `matches`
    pub utils: Option<RapidMap<String, SerializableRule>>,
    ...
    pub transform: Option<RapidMap<String, Transformation>>,
...
mod test {
    ...
    use thread_ast_engine::matcher::{Pattern, RegexMatcher};
