...
macro_rules! into_lang {
    ($lang: ident, $field: ident) => {
        unimplemented!("tree-sitter parser is not implemented when feature flag [all] is off.")
    };
    ($lang: ident) => {
        into_lang!($lang, LANGUAGE)
    };
...
#[cfg(any(feature = "all", feature = "web-only"))]
macro_rules! into_napi_lang {
    ($lang: path) => {
        $lang.into()
    };
}
#[cfg(not(any(feature = "all", feature = "web-only")))]
macro_rules! into_napi_lang {
    ($lang: path) => {
        unimplemented!("tree-sitter parser is not implemented when feature flag [all] is off.")
    };
