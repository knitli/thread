...
use ag_service_rule::{RuleConfig, RuleId};
use ag_service_tree_sitter::{StrDoc, Matcher, NodeMatch as SgNodeMatch};
...
type NodeMatch<'a> = SgNodeMatch<'a, StrDoc<ThreadLang>>;
...
impl<'n> Diff<'n> {
  ...
  /// tree-sitter's root Node may not start at the beginning
