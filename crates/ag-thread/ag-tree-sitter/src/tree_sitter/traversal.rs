...
use ag_service_types::{Algorithm, Traversal, Visit, Visitor, TsPre, Pre, Post, Level, TSNode};
...
pub mod Traversal {
  //! This module contains the tree-sitter traversal algorithms.
  //!
  ...
  //! - Level-order traversal
  //!
  //! Each algorithm is implemented as an iterator over `Node` or `NodeMatch`.
  //!
  //! The algorithms can be used with a `Matcher` to filter nodes during traversal.
  pub use super::{Level, Post, Pre, Visit, Visitor, TsPre};
}
