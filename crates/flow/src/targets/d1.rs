...
impl D1ExportContext {
    ...
    pub fn build_upsert_stmt(
        ...
        use std::fmt::Write;
        // Bolt optimization: Pre-allocate capacity and avoid intermediate vectors/formats
        let mut params = Vec::with_capacity(key.0.len() + values.fields.len());
        let mut sql = String::with_capacity(128 + self.table_name.len());
    ...
    pub fn build_delete_stmt(
        ...
        let mut sql = String::with_capacity(64 + self.table_name.len());
