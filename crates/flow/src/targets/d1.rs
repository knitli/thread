...
impl D1ExportContext {
    ...
    pub fn build_upsert_stmt(
        ...
        // ⚡ Bolt: Optimize SQL generation by writing directly to a pre-allocated string
        // to avoid multiple intermediate Vec allocations, string clones, and joins.
    ...
    pub fn build_delete_stmt(
        ...
        // ⚡ Bolt: Optimize SQL generation by writing directly to a pre-allocated string
        // to avoid multiple intermediate Vec allocations and string copies.
