...
### Bug Fixes
 ...
 - <csr-id-24380e6d757b6e968d26d4c4107868fd739d0962/> sync thread-utilities version to 0.1.2 matching crates.io
   The local manifest was at 0.1.1 while crates.io already had 0.1.2
   published. cargo-smart-release with --bump-dependencies patch would
   compute 0.1.1 → 0.1.2. but collide with the existing published version,
   aborting the release. Syncing to 0.1.2 resolves the conflict.
 ...
 * **Uncategorized**
    - Sync thread-utilities version to 0.1.2 matching crates.io ([`24380e6`](https://github.com/knitli/thread/commit/24380e6d757b6e968d26d4c4107868fd739d0962))
    ...
    - Add service layer ([`50f017c`](https://github.com/knitli/thread/commit/50f017c97b8227efedd54b17c623403fdd0575f8))
</details>
