...
Thanks for wanting to help make Thread better! Before you start, please read this. If anything’s unclear, [email Adam](mailto:adam@knit.li) or post in the [forum](https://github.com/knitli/thread/discussions). (Right now, Adam *is* Knitli.)

---

## What You’re Agreeing To 📝

By submitting code, docs, or anything else to Thread, you agree:

- **You give Knitli Inc.[^1] permission** to use, change, and share[^2] your contributions—**forever**. That includes open source (AGPL), commercial, or any other context, and lets us license it to others.
- **Patent rights:** If your code is covered by any existing or future patents, you grant us and all Thread users a free license to use them, but only as far as your contribution goes.
...
- **Open stays open:** The open source version of Thread will always be available under an OSI-approved license (right now, AGPL). Your contributions will always be open source, even if we add commercial licensing.
...
## Thanks for making Thread better! You rock! 🎸✨
